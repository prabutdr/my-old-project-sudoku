...
/*
        while(true) {
            ...
            if(fillCount == size * size) {
                ...
                if(this.tryLevel_3(false) == false)
                    return solutionCount;
            }
        }
 */
        while(true) {
            ...
            if(fillCount == size * size) {
                solutionCount++;
                System.out.println("First Solution Count: " + solutionCount);
                this.print();
                break;
            }
        }
        ...
        while(true) {
            ...
            if(fillCount == size * size) {
                solutionCount++;
                System.out.println("Second Solution Count: " + solutionCount);
                this.print();
                break;
            }
        }
